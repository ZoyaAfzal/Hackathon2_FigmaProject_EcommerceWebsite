...
function Categories() {
  return (
    <div className="lg:max-w-[1200px] max-w-[1500px] xl:w-[1500px] xl:mt-40 xs:h-[340px] xxs:h-[360px] md:h-[240px] w-full flex justify-center items-center sm:mt-[60%] md:mt-0 lg:mt-20 xs:mt-8 px-4 xs:mx-8 xxs:ml-6 ">
