...
function Essentials() {
  return (
    <div className="lg:w-[1234px] max-w-[1320px] w-full xs:h-[1950px] lg:h-[1420px] xs:mt-20 h-auto flex flex-col items-center justify-center px-4 md:mt-[620px] lg:mt-2 sm:mt-[186%] ">
      {/* Section Heading */}
