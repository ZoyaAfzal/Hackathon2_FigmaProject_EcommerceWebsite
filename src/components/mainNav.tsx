...
const [maxWidthClass, setMaxWidthClass] = useState(() =>
  ...
  useEffect(() => {
    const handleResize = () => {
      setMaxWidthClass(window.innerWidth >= 1262 ? 'max-w-[1800px]' : 'lg:max-w-[1262px]');
    };
  ...
  return (
    <div className={`hidden md:flex ${maxWidthClass} xl:max-w-[1800px] w-full h-16 justify-between items-center border-b-[1px] border-gray-200 pl-14 cursor-pointer md:pl-10`}>
