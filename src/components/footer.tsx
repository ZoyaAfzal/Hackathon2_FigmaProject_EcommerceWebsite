    ...
    <div className='max-w-full w-full h-auto flex justify-center items-center lg:mt-[26%] md:mt-[26%] mt-[160%] bg-black text-white'>
      <div className="max-w-[1180px] w-full h-auto grid  grid-cols-1 md:grid-cols-2 mt-16 mr-6 gap-8 ">
        <div className="max-w-[832px] w-full h-[23] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-44 md:gap-4 gap-y-20 mx-4">
          ...
          <div className="w-[337px]  h-[37px] flex  flex-wrap lg:justify-end lg:items-end lg:ml-[270px] justify-start items-start lg:gap-x-7 ml-[20px] pt-16 md:pt-[386px] lg:pt-1 gap-x-10">
          ...
          <div className="flex w-full h-auto flex-wrap justify-between items-center border-t border-gray-800 lg:w-[1200px] bg-gray-260 mt-20 md:w-[768px] md:p-2">
           ...
           <span className="ml-8 text-[#7E7E7E] text-sm">© 2023 Nike, Inc. All Rights Reserved.</span>
            ...
            <div className="flex flex-wrap justify-end sm:flex-col">
              <ul className='flex text-[#7E7E7E] text-sm lg:gap-8 gap-8 mt-6 mr-4 md:gap-32'>
               <li>Guides</li>
               <li>Terms of Sale</li>
               <li>Terms of Use</li>
