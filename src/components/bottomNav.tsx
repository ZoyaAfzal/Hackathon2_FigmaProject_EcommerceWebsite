...
function BottomNav() {
  return (
    <div className='w-full h-14 hidden md:flex lg:max-w-[1262px] max-w-[1800px] xl:max-w-[1800px] bg-colors-bgColor  justify-center items-center border-b-[1px] border-gray-200
    '>
